...
const cards = () =>
   cardsInfo.map((card, index) => <Card key={index} {...card} />)
   ...
   return (
      <div className=" bg-slate-500">
         ...
         <div className=" ml-auto mr-auto flex h-screen w-full items-center bg-[#0A001B] ">
            <div className="flex w-full flex-col-reverse items-center justify-between gap-20 xl:max-w-[80%] xl:flex-row">
               <div className="bg-red- flex w-full flex-col justify-center  px-9 text-white md:px-0 ">
                  ...
                  <p className=" max-w-2xl self-center pt-5 text-justify xl:pt-7">
                     ...
                     aprender nuevas técnologías, en la creación de código
                     limpio y en el desarrollo de interfaces que, además de
                     estéticas, ofrezcan una buena experiencia de usuario.
                  </p>
               </div>
               <img
                  src="/images/pc.jpeg"
            ...
            {/**
               <div className=" absolute bottom-0 h-12 w-full rounded-full bg-green-400">
               <svg
                  className=""
                  class="svg-curve"
                  viewBox="0 0 1440 79"
         ...
         {/* trabajos */}
         <div className="CONTAINER mx-auto max-w-7xl  bg-[#E2E0E7] py-28 sm:px-6 lg:px-8">
            <div className="grid  grid-cols-1 gap-4 md:grid-cols-2">
               {cards()}
            </div>
         </div>
         {/*FOOTER*/}
         <footer className="bg-[#0A001B]">
